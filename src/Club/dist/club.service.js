...
var ClubService = /** @class */ (function () {
    ...
    ClubService.prototype.applyClub = function (clubtype, clubtitle, email) {
        return __awaiter(this, void 0, void 0, function () {
            var clubData, userData, check;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.Club.findOne({
                    ...
                    case 2:
                        userData = _a.sent();
                        return [4 /*yield*/, this.RequestJoin.find({ where: { user: userData } })];
                    case 3:
                        check = _a.sent();
                        if (check[0]) {
                            throw new common_1.HttpException('이미 동아리에 지원한 상태입니다.', common_1.HttpStatus.CONFLICT);
                        }
                        if (!clubData) {
    ...
    ClubService.prototype.acceptClub = function (clubtype, clubtitle, acceptUserId, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var clubData, userData, checkMemmber, check, acceptUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.Club.findOne({
                            where: { type: clubtype, title: clubtitle },
                    ...
                    case 3:
                        checkMemmber = _a.sent();
                        check = checkMemmber.filter(function (member) {
    ...
    ClubService.prototype.editClub = function (editClubData, email) {
        return __awaiter(this, void 0, void 0, function () {
            var newActivityUrls, deleteActivityUrls, clubData, _i, newActivityUrls_1, image, clubImage, _a, deleteActivityUrls_1, image, clubImageData;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        newActivityUrls = editClubData.newActivityUrls, deleteActivityUrls = editClubData.deleteActivityUrls;
                        return [4 /*yield*/, this.Club.findOne({
                                where: {
                    ...
                    case 1:
                        ...
                        if (!newActivityUrls) return [3 /*break*/, 13];
                        _i = 0, newActivityUrls_1 = newActivityUrls;
                        _b.label = 2;
                    case 2:
                        if (!(_i < newActivityUrls_1.length)) return [3 /*break*/, 6];
                        image = newActivityUrls_1[_i];
                    ...
                    case 5:
                        ...
                        return [3 /*break*/, 2];
                    case 6:
                        if (!deleteActivityUrls) return [3 /*break*/, 11];
                        _a = 0, deleteActivityUrls_1 = deleteActivityUrls;
                        _b.label = 7;
                    case 7:
                        if (!(_a < deleteActivityUrls_1.length)) return [3 /*break*/, 11];
                        image = deleteActivityUrls_1[_a];
                        return [4 /*yield*/, this.Image.findOne({
                                where: { club: clubData.id, url: image }
                            })];
                    case 8:
                        clubImageData = _b.sent();
                        if (!clubImageData) {
                    ...
                    case 10:
                        _a++;
                        return [3 /*break*/, 7];
                    case 11: return [4 /*yield*/, this.Club.update({ title: editClubData.q, type: editClubData.type }, {
